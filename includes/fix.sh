...
sed -i '' -e 'sP\<readline/readline.h>P</Users/'$USER'/goinfre/.brew/opt/readline/include/readline/readline.h>Pg' $PWD/minishell.h
sed -i '' -e 'sP\<readline/history.h>P</Users/'$USER'/goinfre/.brew/opt/readline/include/readline/history.h>Pg' $PWD/minishell.h
